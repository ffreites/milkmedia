    	                ...
    	                <div id="bb-vcvs-general-settings" className="bb-col-settings">
    	                    ...
    	                    <div className="inside tabs-container">
    							...
    							<div id="bb-vcvs-misc" className="tab-content">
                                    ...
                                    <span className="bb-label">Image Sequence</span>
                                    <label className="switch">
                                    ...
                                    <span className="bb-label">Image Sequence Repeat</span>
                                    <label className="bb-field">
                                      <input type="text" className="bb-field" name="imageSequenceRepeat" value={this.state.settings.misc.imageSequenceRepeat} onChange={this.onChangeMisc} />
                                    </label>
    	                            <div className="clear"></div>
